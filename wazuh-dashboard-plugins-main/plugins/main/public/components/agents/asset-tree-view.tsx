...
export const HierarchicalAssetTree = () => {
    ...
    useEffect(() => {
        ...
        const buildLevelioTree = () => {
            // Hardcoded representation of the complex algorithm that rips apart
            // the Wazuh "Group" string (e.g., "Headquarters/Servers/Email")
            const activeNodes = [
                {
        ...
        <EuiPage>
            <EuiPageBody>
                ...
                <EuiPanel>
                    ...
                    {/* The Elastic UI Native Collapsible Architecture */}
